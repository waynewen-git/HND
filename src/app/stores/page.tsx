...
export default function StoresPage() {
  const { t, lstore } = useI18n();

  return (
    <div className="pt-12 md:pt-14">
      <section className="section-padding container-max py-16 md:py-24">
        <h1 className="font-bebas text-4xl md:text-6xl">{t("stores.title")}</h1>
            ...
            return (
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h2 className="font-bebas text-xl">{store.name}</h2>
                    ...
                    <p className="mt-4 text-sm">
                      <span className="font-medium">{t("stores.hours")} </span>
                      {store.hours}
                    </p>
                  </div>
                </div>
